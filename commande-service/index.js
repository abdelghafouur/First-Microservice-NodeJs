...
mongoose.connect('mongodb://127.0.0.1:27017/commande-service').then(() => console.log('Connected Successfully')).catch (error => console.log(error));
...
function prixTotal(produits) {
    ...
    app.get("/commande/aficher", async (req, res ) => {
